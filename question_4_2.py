# -*- coding: utf-8 -*-
"""
Created on Wed Jun 12 20:57:05 2013
...
plt.figure()      
plt.plot(x11, x12, 'xr', label = 'Walking')
plt.plot(x21, x22, '+b', label = 'Upstairs')
plt.plot(x31, x32, 'xb', label = 'Downstairs')
plt.plot(x41, x42, '+r', label = 'Sitting')
plt.plot(x51, x52, 'xg', label = 'Standing')
plt.plot(x61, x62, '+g', label = 'Laying')
